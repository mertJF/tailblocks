...
function LightLoginA(props) {

   return (
        <section className="bg-gray-300 text-gray-700 body-font">
          ...
          <div class="container mx-auto p-8">
            <div class="mx-auto max-w-md">
                ...
                <div class="mt-6">
                    <p class="mt-4 mb-4 text-center text-gray-700">OR</p>
                    <div class="flex justify-between">
...
LightLoginA.defaultProps = {
  theme: 'indigo'
};

LightLoginA.propTypes = {
  theme: PropTypes.string.isRequired
};

export default LightLoginA;