    ...
    <section className="text-gray-600 body-font dark:text-gray-400 dark:bg-gray-900">
      <div className="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
        ...
        <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
          <button className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none dark:bg-gray-800 dark:hover:bg-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <svg
            ...
            <span className="ml-4 flex items-start flex-col leading-none">
              <span className="text-xs text-gray-600 mb-1 dark:text-gray-500 dark:text-gray-500">GET IT ON</span>
