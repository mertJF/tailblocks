          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 dark:text-gray-400 dark:bg-gray-900">
            ...
            <div className="flex mb-4 dark:border-gray-800">
              <span className="flex items-center">
                <svg
                  ...
                  strokeWidth="2"
                  className="w-4 h-4 text-theme-500 dark:text-theme-400"
                  viewBox="0 0 24 24"
                >
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                <button className="border-2 border-gray-300 ml-1 bg-theme-500 rounded-full w-6 h-6 focus:outline-none dark:border-gray-700 dark:focus:ring-theme-900 dark:focus:border-theme-500 dark:text-white"></button>
              </div>
              <div className="flex ml-6 items-center dark:text-white dark:bg-theme-500 dark:hover:bg-theme-600">
                <span className="mr-3 dark:text-gray-600">Size</span>
                <div className="relative dark:text-white">
                  <select className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-theme-200 focus:border-theme-500 text-base pl-3 pr-10">
                    <option>SM</option>
                    <option>M</option>
                    <option>L</option>
                    <option>XL</option>
            ...
            <div className="flex">
              ...
              <button className="flex ml-auto text-white bg-theme-500 border-0 py-2 px-6 focus:outline-none hover:bg-theme-600 rounded">
                Button
              </button>
...
EcommerceB.defaultProps = {
  theme: 'indigo'
};

EcommerceB.propTypes = {
