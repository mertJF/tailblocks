  ...
  return (
    <footer className="text-gray-600 body-font dark:text-gray-400 dark:bg-gray-900">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4 dark:text-gray-400 dark:sm:border-gray-800">
          © 2020 Tailblocks —
          <a href="https://twitter.com/knyttneve" className="text-gray-600 ml-1 dark:text-gray-500 dark:text-gray-400" rel="noopener noreferrer" target="_blank">
            @knyttneve
          </a>
        </p>
