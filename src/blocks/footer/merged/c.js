          ...
          <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
            <div className="relative sm:w-64 w-40 sm:mr-4 mr-2">
              ...
              <input
                ...
                id="footer-field"
                name="footer-field"
                className={`w-full bg-gray-100 dark:bg-gray-800 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:bg-transparent focus:ring-${props.theme}-200 focus:border-${props.theme}-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out`}
              />
            </div>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center dark:text-gray-500 dark:text-gray-400">
