    ...
    <footer className="text-gray-600 body-font dark:text-gray-400 dark:bg-gray-900">
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                ...
                <input
                  ...
                  id="footer-field"
                  name="footer-field"
                  className={`w-full bg-gray-100 dark:bg-gray-800 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-${props.theme}-200 focus:border-${props.theme}-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out`}
                />
              </div>
      ...
      <div className="bg-gray-100 dark:bg-gray-800">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 sm:ml-6 sm:mt-0 mt-4 dark:text-gray-400">
            © 2020 Tailblocks —
