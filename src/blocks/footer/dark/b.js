    ...
    <footer className="text-gray-500 bg-gray-900 body-font">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-no-wrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
          <a href className="cursor-pointer flex title-font font-medium items-center md:justify-start justify-center text-white">
            <svg
        ...
        <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a href className="cursor-pointer text-gray-600 hover:text-white">First Link</a>
              </li>
              <li>
                <a href className="cursor-pointer text-gray-600 hover:text-white">Second Link</a>
              </li>
              <li>
                <a href className="cursor-pointer text-gray-600 hover:text-white">Third Link</a>
              </li>
              <li>
                <a href className="cursor-pointer text-gray-600 hover:text-white">Fourth Link</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="bg-gray-800">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            ...
            <a href className="cursor-pointer ml-3 text-gray-600">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
