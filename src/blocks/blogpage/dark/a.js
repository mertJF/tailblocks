    ...
    <section className="text-gray-400 bg-gray-900 body-font">
      <div className="container mx-auto px-5 py-24 flex flex-col items-start justify-center">
        <div className="flex md:flex-row-reverse flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:text-left items-start text-center">
            ...
            <a href className="flex items-center justify-start my-6 md:my-10">
              ...
              />
              <span className="flex-grow flex justify-start items-start flex-col pl-4">
                <span className="title-font font-medium text-white">
                  Holden Caulfield
                </span>
                <span className="text-gray-500 text-xs tracking-normal mt-0.5">
...
DarkBlogPageA.defaultProps = {
  theme: "indigo",
};

DarkBlogPageA.propTypes = {
  theme: PropTypes.string.isRequired,
};

export default DarkBlogPageA;
