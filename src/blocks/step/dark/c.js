    ...
    <section className="text-gray-400 bg-gray-900">
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
          ...
          <div className={`flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-${props.theme}-500 text-white relative z-10 font-medium text-sm`}>
            1
          </div>
          <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
            ...
            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
              <h2 className="font-medium text-white mb-1 text-xl">
                Shooting Stars
              </h2>
