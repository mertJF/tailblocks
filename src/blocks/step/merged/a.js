          ...
          <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
            <div className="flex relative pb-12">
              <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                <div className="h-full w-1 bg-gray-200 pointer-events-none dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800"></div>
              </div>
              ...
              <div className="flex-grow pl-4">
                <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider dark:text-white dark:text-white dark:text-white dark:text-white dark:text-white">
                  STEP 1
                </h2>
