      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
              ...
              <span className="title-font font-medium dark:text-white dark:text-white dark:text-white dark:text-white dark:text-white dark:text-white">
