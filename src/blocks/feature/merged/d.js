        ...
        <div className="flex flex-wrap -m-4">
          <div className="p-4 lg:w-1/2 md:w-full">
            <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col dark:border-gray-800">
              <div className="w-16 h-16 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full bg-theme-100 text-theme-500 flex-shrink-0 dark:bg-gray-800 dark:text-theme-400">
                <svg
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
